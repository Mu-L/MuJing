...
val TextSelectStart: ImageVector
    get() {
        if (_TextSelectStart != null) {
            return _TextSelectStart!!
        }
        _TextSelectStart = ImageVector.Builder(
...
private var _TextSelectStart: ImageVector? = null
